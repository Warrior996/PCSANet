...
def pysaresnet34(pretrained=False, **kwargs):
...
def pysaresnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # state_dict = torch.load('model/pyconvresnet50.pth')
        # model.load_state_dict(state_dict, strict=False)

        net_dict = model.state_dict()
        predict_model = torch.load('model/resnet50-19c8e357.pth')
...
def pysaresnet101(pretrained=False, **kwargs):
...
if __name__ == "__main__":
    # net = pyconvresnet50(pretrained=False)
    # print(net)

    net = pysaresnet50(pretrained=True, num_classes=1000)
