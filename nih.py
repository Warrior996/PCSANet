...
def plot_frequency(df, diseases, category, category_name):
    ...
    plt.legend()
    plt.savefig("./results_resnet/Frequency_" + category_name + ".pdf")
...
def plot_TPR_NIH(df, diseases, category, category_name):
    ...
    for c in category:
        ...
        c = c.replace('/', '_', 3)
        c = c.replace('>=', '_', 3)
        plt.savefig("./results_resnet/Median_TPR_" + category_name + "_" + c + ".pdf")
...
def plot_median(df, diseases, category, category_name):
    ...
    for i in range(len(GAP_total)):
       ...
       # mask = GAP_total[i] < 50
        ...
        if category_name == 'Patient Age':
            ...
            Run5_age.to_csv("./results_resnet/Run5_Age.csv")
        ...
        #    Run5_sex.to_csv("./results_resnet/Run5_sex.csv")
    ...
    plt.ylabel("TPR " + ylabel[category_name] + " DISPARITY")
    plt.legend()
    plt.savefig("./results_resnet/Median_Diseases_x_GAP_" + category_name + ".pdf")
