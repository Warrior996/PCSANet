...
def Saved_items(epoch_losses_train, epoch_losses_val, time_elapsed, savepath, batch_size):
    """
    ...
    torch.save(state2, savepath+'Saved_items')

def checkpoint(model, best_loss, best_epoch, savepath, LR):
    """
    Saves checkpoint of torchvision model during training.
    Args:
    ...
    torch.save(state, savepath+'checkpoint')
